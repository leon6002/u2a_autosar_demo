 ...
 *  1.4.1  11/11/2021  : Update to add macro GPT_ATUA_UNIT_USED to enable/disable APIs respectively 
 *                     : Replace ATU5 with ATU in global data: Gpt_GpATU5UnitConfig,Gpt_GpATU5CommonPrescalerConfig.
 ...
 *         06/05/2021  : Updated the Memory section for Gpt_AtuFunc using GPT_START_SEC_VAR_INIT_UNSPECIFIED
...
#define GPT_ATU_RAM_C_AR_RELEASE_MAJOR_VERSION GPT_AR_RELEASE_MAJOR_VERSION_VALUE
#define GPT_ATU_RAM_C_AR_RELEASE_MINOR_VERSION GPT_AR_RELEASE_MINOR_VERSION_VALUE
#define GPT_ATU_RAM_C_AR_RELEASE_PATCH_VERSION GPT_AR_RELEASE_REVISION_VERSION_VALUE

/* File version information */
#define GPT_ATU_RAM_C_SW_MAJOR_VERSION         GPT_SW_MAJOR_VERSION_VALUE
#define GPT_ATU_RAM_C_SW_MINOR_VERSION         GPT_SW_MINOR_VERSION_VALUE

/***********************************************************************************************************************
**                                                   Version Check                                                    **
***********************************************************************************************************************/
#if (GPT_ATU_RAM_AR_RELEASE_MAJOR_VERSION != GPT_ATU_RAM_C_AR_RELEASE_MAJOR_VERSION)
    #error "Gpt_ATU_Ram.c : Mismatch in Release Major Version"
#endif
#if (GPT_ATU_RAM_AR_RELEASE_MINOR_VERSION != GPT_ATU_RAM_C_AR_RELEASE_MINOR_VERSION)
    #error "Gpt_ATU_Ram.c : Mismatch in Release Minor Version"
#endif
#if (GPT_ATU_RAM_AR_RELEASE_REVISION_VERSION != GPT_ATU_RAM_C_AR_RELEASE_PATCH_VERSION)
    #error "Gpt_ATU_Ram.c : Mismatch in Release Revision Version"
#endif
#if (GPT_ATU_RAM_SW_MAJOR_VERSION != GPT_ATU_RAM_C_SW_MAJOR_VERSION)
    #error "Gpt_ATU_Ram.c : Mismatch in Software Major Version"
#endif
#if (GPT_ATU_RAM_SW_MINOR_VERSION != GPT_ATU_RAM_C_SW_MINOR_VERSION)
    #error "Gpt_ATU_Ram.c : Mismatch in Software Minor Version"
#endif
...
P2CONST(Gpt_ATUUnitConfigType, GPT_VAR_NO_INIT, GPT_CONFIG_CONST) volatile Gpt_GpATUUnitConfig;                         /* PRQA S 1531 # JV-01 */
#endif
...
P2CONST(Gpt_ATUCommonPrescalerConfigType, GPT_VAR_NO_INIT, GPT_CONFIG_CONST) volatile Gpt_GpATUCommonPrescalerConfig;   /* PRQA S 1533 # JV-01 */
#endif
...
#include "Gpt_Mapping.h"                                                                                                /* PRQA S 5087 # JV-01 */
/* The Function table for ATU */
VAR(Gpt_HwFuncTableType, GPT_VAR_INIT) Gpt_AtuFunc =                                                                    /* PRQA S 1531 # JV-01 */
{
  &Gpt_HW_Atu_UnitInit,
  &Gpt_HW_Atu_ChannelInit,
  #if (GPT_DE_INIT_API == STD_ON)
  NULL_PTR, /* pHWUnitDeInit */
  &Gpt_HW_Atu_ChannelDeInit,
  #endif
  #if (GPT_TIME_ELAPSED_API == STD_ON)
  &Gpt_HW_Atu_GetTimeElapsed,
  #endif
  #if (GPT_TIME_REMAINING_API == STD_ON)
  &Gpt_HW_Atu_GetTimeRemaining,
  #endif
  &Gpt_HW_Atu_StartTimer,
  &Gpt_HW_Atu_StopTimer,
  &Gpt_HW_Atu_EnableInterrupt,
  &Gpt_HW_Atu_DisableInterrupt,
  ...
  &Gpt_HW_Atu_StartPredefTimer,
  &Gpt_HW_Atu_StopPredefTimer,
  &Gpt_HW_Atu_GetPredefTimerValue
  #endif
};
