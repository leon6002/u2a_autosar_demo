...
P2CONST(Gpt_ChannelConfigType, GPT_VAR_NO_INIT, GPT_CONFIG_CONST) volatile Gpt_GpChannelConfig;
/* Global pointer variable for channel data */
P2VAR(Gpt_ChannelRamDataType, GPT_VAR_NO_INIT, GPT_VAR_NO_INIT) volatile Gpt_GpChannelRamData;                          /* PRQA S 3432 # JV-01 */
#if (GPT_GET_PREDEF_TIMER_VALUE_API == STD_ON)
P2CONST(Gpt_PredefTimerConfigType, GPT_VAR_NO_INIT, GPT_CONFIG_CONST) volatile Gpt_GpPredefTimerConfig;
#endif
...
volatile VAR(boolean, GPT_VAR_INIT) Gpt_GblDriverStatus = GPT_UNINITIALIZED;                                            /* PRQA S 1531 # JV-01 */
...
volatile VAR(uint8, GPT_VAR_NO_INIT) Gpt_GucDriverMode;                                                                 /* PRQA S 1531 # JV-01 */
