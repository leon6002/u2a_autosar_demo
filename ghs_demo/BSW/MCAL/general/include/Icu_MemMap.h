 ...
 * 1.4.0:  07/10/2021  : Update value of ICU_MEMMAP_SW_MINOR_VERSION and 
 *                       ICU_MEMMAP_SW_PATCH_VERSION
 * 1.3.2:  30/08/2021  : Remove Macro of multi instance
 *         16/08/2021  : Update value of ICU_MEMMAP_SW_PATCH_VERSION
 * 1.3.1:  01/06/2021  : Add below sections:
 *                          ICU_START_SEC_CONST_PTR
 *                          ICU_STOP_SEC_CONST_PTR
 *                          DEFAULT_START_SEC_CONST_PTR
 *                          DEFAULT_STOP_SEC_CONST_PTR
 *         06/05/2021  : Add below sections:
 ...
 * 1.0.2:  20/09/2018  : Fixed define name as below
 *                         DEFAULT_START_SEC_VAR_NO_INIT_UNSPECIFIED
 *                         fix to DEFAULT_START_SEC_VAR_NOINIT_UNSPECIFIED.
 *                         DEFAULT_STOP_SEC_VAR_NO_INIT_UNSPECIFIED
 *                         fix to DEFAULT_STOP_SEC_VAR_NOINIT_UNSPECIFIED
 * 1.0.1:  26/01/2018  : Removed unused section as per ARDAABO-372
...
#define ICU_MEMMAP_SW_MINOR_VERSION   5
