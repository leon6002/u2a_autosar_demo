 ...
 * 1.4.0:  07/10/2021  : Update SW-VERSION to 1.4.0                          
 * 1.3.1:  06/05/2021  : Add memory section .NOINIT_RAM_PTR for
 *                       DEFAULT_START_SEC_VAR_NO_INIT_PTR and default for
...
#define PORT_MEMMAP_SW_MINOR_VERSION   5
...
/* -------------------------------------------------------------------------- */
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".PORT_CFG_DATA_1BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".PORT_CFG_DATA_8BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".PORT_CFG_DATA_16BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".PORT_CFG_DATA_32BIT"
   #endif
