 ...
 * 1.4.0:  12/10/2021  : Update SW-VERSION to 1.4.0
 *                       Update value of MCU_MEMMAP_SW_MINOR_VERSION to 4
 *                       Update value of MCU_MEMMAP_SW_PATCH_VERSION to 0
 * 1.3.2:  12/08/2021  : Update SW-VERSION to 1.3.2
 *                       Update value of MCU_MEMMAP_SW_PATCH_VERSION to 2
 * 1.3.1:  12/05/2021  : Add definition for DEFAULT_START_SEC_VAR_NOINIT_PTR
 *                       and DEFAULT_STOP_SEC_VAR_NOINIT_PTR to map to memory
 *                       section ".NOINIT_RAM_PTR"
 * 1.2.0:  26/08/2020  : Release
 * 1.1.0:  19/06/2020  : Release
 * 1.0.2:  19/04/2020  : As per REL Redmine #266566, 
 *                       Remove memap version macro
 * 1.0.1:  30/01/2018  : Fix MCU_START_SEC_CONFIG_VAR_NOINIT_UNSPECIFIED to
 *                       MCU_START_SEC_CONFIG_VAR_NO_INIT_UNSPECIFIED.
 *                       (related ticket:ARDAABO-335)
 * 1.0.0:  23/01/2017  : Initial Version
 *
 */
/******************************************************************************/
...
#define MCU_MEMMAP_SW_MINOR_VERSION   5
...
/* -------------------------------------------------------------------------- */
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".MCU_CFG_DATA_1BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".MCU_CFG_DATA_8BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".MCU_CFG_DATA_16BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".MCU_CFG_DATA_32BIT"
   #endif
   ...
   #ifdef MCU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define MCU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
   ...
   #ifndef MCU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  MCU_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
