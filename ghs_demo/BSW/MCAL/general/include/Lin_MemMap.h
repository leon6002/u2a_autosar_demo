 ...
 * 1.4.0:  13/10/2021  : Update LIN_MEMMAP_SW_MINOR_VERSION to 4
 *                       Update LIN_MEMMAP_SW_PATCH_VERSION to 0
 * 1.3.2:  12/08/2021  : Update LIN_MEMMAP_SW_PATCH_VERSION
 * 1.3.1:  17/05/2021  : Update memory section:  
                         From LIN_START_SEC_VAR_NO_INIT_32BIT to 
                         LIN_START_SEC_VAR_NO_INIT_PTR 
                         From LIN_STOP_SEC_VAR_NO_INIT_32BIT to 
                         LIN_STOP_SEC_VAR_NO_INIT_PTR 
                         Remove DEFAULT_START_SEC_VAR_NOINIT_UNSPECIFIED
                         Update LIN_MEMMAP_SW_PATCH_VERSION
 * 1.3.0:  15/12/2020  : Release
 * 1.2.1:  15/12/2020  : Update File version information 
 * 1.2.0:  26/08/2020  : Release
 * 1.1.0:  19/06/2020  : Release
 * 1.0.2:  03/02/2020  : Update version information to support AR 4.3.1
 * 1.0.1:  30/01/2018  : Fix LIN_START_SEC_BURAM_VAR_NOINIT_UNSPECIFIED,
 *                             LIN_STOP_SEC_BURAM_VAR_NOINIT_UNSPECIFIED,
 *                             LIN_START_SEC_CONFIG_VAR_NOINIT_UNSPECIFIED,
 *                             LIN_STOP_SEC_CONFIG_VAR_NOINIT_UNSPECIFIED,
 *                             to
 *                             LIN_START_SEC_BURAM_VAR_NO_INIT_UNSPECIFIED,
 *                             LIN_STOP_SEC_BURAM_VAR_NO_INIT_UNSPECIFIED,
 *                             LIN_START_SEC_CONFIG_VAR_NO_INIT_UNSPECIFIED,
 *                             LIN_STOP_SEC_CONFIG_VAR_NO_INIT_UNSPECIFIED,
...
#define LIN_MEMMAP_SW_MINOR_VERSION   5
...
/* -------------------------------------------------------------------------- */
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".LIN_CFG_DATA_1BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".LIN_CFG_DATA_8BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".LIN_CFG_DATA_16BIT"
   #endif
     ...
     #pragma ghs startsda
     #pragma ghs section rosdata=".LIN_CFG_DATA_32BIT"
   #endif
   ...
   #ifdef LIN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not stopped"
   #else
     #define LIN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
   ...
   #ifndef LIN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
     #error "Memory section is not started"
   #else
     #undef  LIN_CONFIG_DATA_UNSPECIFIED_SEC_STARTED
